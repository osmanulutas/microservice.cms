...
{
    public class WriteRepository<T>(MicroserviceAccountWriteContext context) : RepositoryBase<T>(context), IWriteRepository<T> where T : class
    {
        protected readonly MicroserviceAccountWriteContext Context = context ?? throw new ArgumentNullException(nameof(context));
